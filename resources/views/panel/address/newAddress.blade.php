            ...
            <div class="col-md-12 col-xl-12 col-xs-12 col-sm-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="needs-validation was-validated" method="post" action="{{ route('address.store') }}">
                            @csrf
                            <div class="form-row">
                                ...
                                <div class="col-md-6 mb-4">
                                    <input id="lat" name="latitude" placeholder="مثال : 09151234567" type="hidden" value="{{ old('latitude','35.699739') }}">
                                    <input id="lng" name="longitude" placeholder="مثال : 09151234567" type="hidden" value="{{ old('longitude','51.338097') }}">
                                </div>
