...
@section('header')
<title>مدیریت زمان بندی رستوران</title>
                ...
                <div class="card">
                    <div class="card-header pb-0">
                        <div class="d-flex justify-content-between">
                            <h4 class="card-title mg-b-0">لیست رستوران ها</h4>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive border-top userlist-table">
                            <table class="table card-table table-striped table-vcenter text-nowrap mb-0">
                                <thead>
                                <tr>
                                    <th class="wd-lg-8p"><span>روز هفته</span></th>
                                    <th class="wd-lg-20p"><span>ساعت شروع به کار</span></th>
                                    <th class="wd-lg-20p"><span>ساعت پایان کار</span></th>
                                    <th class="wd-lg-20p"><span>وضعیت رستوران</span></th>
                                ...
                                @foreach($schedules as $schedule)
                                    <tr>
                                        <td>{{ $schedule->day }}</td>
                                        <td>{{ $schedule['from_hours'] }}</td>
                                        <td>{{ $schedule['to_hours'] }}</td>
                                        <td>{{ $schedule->is_closed }}</td>
                                        <td>
                                            <a href="{{ route('seller.schedule.edit',$schedule['id']) }}" class="btn btn-sm btn-info">
                                                <i class="las la-pen"></i>
                                            </a>
                                            <form action="{{ route('seller.schedule.destroy',$schedule['id']) }}" method="post" class="d-inline">
                                                @csrf
                                                @method('delete')
