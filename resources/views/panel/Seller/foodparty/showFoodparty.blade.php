...
@section('header')
<title>مدیریت غذاهای فودپارتی</title>
                ...
                <div class="card">
                    <div class="card-header pb-0">
                        <div class="d-flex justify-content-between">
                            <h4 class="card-title mg-b-0">مدیریت غذاهای فود پارتی</h4>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive border-top userlist-table">
                            <table class="table card-table table-striped table-vcenter text-nowrap mb-0">
                                ...
                                <tbody>
                                @foreach($foodparties as $food)
                                    <tr>
                                        <td>{{ $food->food->name }}</td>
                                        <td>{{ $food->discount ? $food->discount->title : 'بدون تخفیف' }}</td>
                                        <td>{{ $food['food_count'] }}</td>
                                        <td>
                                            <a href="{{ route('seller.foodparty.edit',$food['id']) }}" class="btn btn-sm btn-info">
                                                <i class="las la-pen"></i>
                                            </a>
                                            <form action="{{ route('seller.foodparty.destroy',$food['id']) }}" method="post" class="d-inline">
                                                @csrf
                                                @method('delete')
