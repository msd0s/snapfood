            ...
            <div class="col-md-12 col-xl-12 col-xs-12 col-sm-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="needs-validation was-validated" method="post" action="{{ route('seller.restaurant.update',$restaurantItem->id) }}" enctype="multipart/form-data">
                            @csrf
                            @isset($restaurantItem)
                                @method('patch')
                            @endisset
                            <div class="form-row">
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="name" name="name" placeholder="" value="{{ old('name',isset($restaurantItem) ? $restaurantItem['name'] : '') }}" tabindex="1">
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        <label for="phoneNumber">شماره تلفن</label>
                                        <input type="text" class="form-control" id="phoneNumber" name="phone" placeholder="" value="{{ old('phone',isset($restaurantItem) ? $restaurantItem['phone'] : '') }}" tabindex="1">
                                    </div>
                                </div>
                                <div class="col-md-6 mb-4">
                                    <div class="form-group">
                                        <label for="restaurantcategory_id">نوع رستوران</label>
                                        <select multiple="multiple" name="restaurantcategory_id[]" class="testselect2 form-control" id="restaurantcategory_id">
                                            @forelse($cats as $cat)
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="account_number" name="account_number" placeholder="مثال : 6037997341872969" value="{{ old('account_number',isset($restaurantItem) ? $restaurantItem['account_number'] : '') }}" tabindex="9">
                                    </div>
                                </div>
                                <div class="col-md-6 mb-4">
                                    <label>تصویر رستوران</label>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        <label for="send_price">هزینه ارسال</label>
                                        <input type="number" class="form-control" id="send_price" name="send_price" placeholder="" value="{{ old('send_price',isset($restaurantItem) ? $restaurantItem['send_price'] : '') }}" tabindex="11">
                                    </div>
                                </div>
                                <div class="col-md-6 mb-4">
                                    <div class="form-group">
                                        <label for="restaurant_status">وضعیت رستوران</label>
                                        <select name="restaurant_status" class="form-control" id="restaurant_status">
                                            <option value="1" {{ isset($restaurantItem) && $restaurantItem->restaurant_status==1 ? 'selected' : '' }}>باز</option>
                                            <option value="0" {{ isset($restaurantItem) && $restaurantItem->restaurant_status==0 ? 'selected' : '' }}>بسته</option>
                                        </select>
                                    </div>
                                </div>
