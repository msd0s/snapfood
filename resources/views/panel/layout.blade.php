            ...
            @can('admin-role')
                ...
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="#">
                        ...
                        <span class="side-menu__label">بنرها</span><i class="angle fe fe-chevron-down"></i></a>
                    <ul class="slide-menu">
                        <li><a class="slide-item" href="{{ route('admin.banner.create') }}">ثبت بنر
                                جدید</a></li>
                        <li><a class="slide-item" href="{{ route('admin.banner.index') }}">مدیریت بنر
                                ها</a></li>
                    </ul>
                </li>
            @endcan
            ...
            @can('seller-role')
                ...
                <li class="slide">
                    <a class="side-menu__item" href="{{ route('seller.archivedorder.show') }}">
                        ...
                        <span class="side-menu__label">گزارشات فروش </span></a>
                </li>
