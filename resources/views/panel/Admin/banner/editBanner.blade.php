...
@section('header')
    <title>ویرایش اطلاعات بنر</title>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="title" name="title" placeholder=""
                                               value="{{ old('title',$banner['title']) }}" tabindex="1">
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="url" name="url" placeholder=""
                                               value="{{ old('url',$banner['url']) }}" tabindex="1">
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="alternate" name="alternate"
                                               placeholder="" value="{{ old('alternate',$banner['alternate']) }}" tabindex="1">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 mb-4">
                                    <div class="form-group">
                                        ...
                                        <select name="status" class="form-control" id="status">
                                            ...
                                            <option @if($banner['status']==0) selected @endif value="0">غیرفعال</option>
                                        </select>
                                    </div>
                                </div>
