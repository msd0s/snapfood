                ...
                <div class="card">
                    <div class="card-header pb-0">
                        <div class="d-flex justify-content-between">
                            <h4 class="card-title mg-b-0">لیست بنرها</h4>
                        ...
                        <div class="table-responsive border-top userlist-table">
                            <table class="table card-table table-striped table-vcenter text-nowrap mb-0">
                                ...
                                <tr>
                                    ...
                                    <th class="wd-lg-20p"><span>آدرس URL</span></th>
                                    <th class="wd-lg-20p"><span>متن جایگزین</span></th>
                                ...
                                @forelse($banners as $banner)
                                    <tr>
                                        <td>{{ $banner['title'] }}</td>
                                        <td>{{ $banner['url'] }}</td>
                                        <td>{{ $banner['alternate'] }}</td>
                                        <td>
                                            <a href="{{ route('admin.banner.edit',$banner['id']) }}" class="btn btn-sm btn-info">
