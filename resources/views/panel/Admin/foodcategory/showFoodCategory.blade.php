...
@section('header')
<title>مدیریت دسته بندی غذاها</title>
...
@section('content')
                            ...
                            <table class="table card-table table-striped table-vcenter text-nowrap mb-0">
                                ...
                                @foreach($cats as $cat)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.foodcategory.edit',$cat['id']) }}" class="btn btn-sm btn-info">
                                                <i class="las la-pen"></i>
                                            </a>
                                            <form action="{{ route('admin.foodcategory.destroy',$cat['id']) }}" method="post" class="d-inline">
                                                @csrf
                                                @method('delete')
    ...
    function catfind($catid){
        if ($catid == 0) {
            ...
            $category = \App\Models\FoodCategory::find($catid);
        }
