...
@section('content')
                ...
                <div class="card">
                    <div class="card-header pb-0">
                        <div class="d-flex justify-content-between">
                            <h4 class="card-title mg-b-0">لیست کدهای تخفیف</h4>
                        ...
                        <div class="table-responsive border-top userlist-table">
                            <table class="table card-table table-striped table-vcenter text-nowrap mb-0">
                                ...
                                <tr>
                                    ...
                                    <th class="wd-lg-20p"><span>مبلغ تخفیف</span></th>
                                ...
                                @foreach($discounts as $discount)
                                    <tr>
                                        ...
                                        <td>{{ $discount['price'] }} ریال</td>
                                        <td>{{ $discount['percent'] }} درصد</td>
                                        <td>
                                            <a href="{{ route('admin.discount.edit',$discount['id']) }}" class="btn btn-sm btn-info">
    ...
    function catfind($catid){
        if ($catid == 0) {
            ...
            $category = \App\Models\Discount::find($catid);
        }
